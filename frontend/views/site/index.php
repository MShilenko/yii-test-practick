        ...
        <?php foreach ($feedItems as $feedItem): ?>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <a href="#" class="btn btn-primary button-unlike <?php echo ($currentUser->likesPost($feedItem->post_id)) ? "" : "d-none"; ?>" data-id="<?php echo $feedItem->post_id; ?>">
                        Unlike&nbsp;&nbsp;<span class="glyphicon glyphicon-thumbs-down"></span>
                    </a>
                    <a href="#" class="btn btn-primary button-like <?php echo ($currentUser->likesPost($feedItem->post_id)) ? "d-none" : ""; ?>" data-id="<?php echo $feedItem->post_id; ?>">
